...
\section{Objetivo}
Desenvolvedor Back-End Jr com experiência no desenvolvimento de sistemas web, automações, integrações e soluções orientadas a APIs. Atuação com PHP, Python e Go, utilizando frameworks modernos, Docker e arquitetura escalável para construção de aplicações robustas, organizadas e eficientes.
